...
use constant {
    ...
    USER_AGENT => 'ECConfluenceRESTClient REST Client',
...
Use this method to create a new FlowPlugin::ECConfluenceRESTClient, e.g.

    my $client = FlowPlugin::ECConfluenceRESTClient->new($endpoint,
...
sub createPage {
    ...
    $self->{method} = 'createPage';
    $self->{methodParameters} = \%params;

    my $uri = "/rest/api/content";
